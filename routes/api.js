...
var creator = 'BarrGans' // ubah jadi nama lu
const listkey = ["XzyBot","Barr","BarrGans"]; // ubah apikey nya, tambah aja klo mau
...
var len = 15
 ...
 router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != `${Barr}`) return res.json(loghandler.invalidKey)
